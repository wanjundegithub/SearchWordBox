...
namespace SearchWordBox.Behaviors
{
    public class ButtonClearBehavior
    {
        ...
        public static readonly DependencyProperty IsClearButtonProperty =
            DependencyProperty.RegisterAttached("IsClearButton", typeof(bool), typeof(ButtonClearBehavior), new PropertyMetadata(false, ClearText));
